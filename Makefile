...
binaries/proxysql-${CURVER}-1-centos5.x86_64.rpm:
	...
	docker exec centos5_build bash -c "cd /opt; git clone -b v${CURVER} https://github.com/ddelnano/proxysql.git proxysql"
...
binaries/proxysql-${CURVER}-1-centos67.x86_64.rpm:
	...
	docker exec centos67_build bash -c "cd /opt; git clone -b v${CURVER} https://github.com/ddelnano/proxysql.git proxysql"
...
binaries/proxysql-${CURVER}-1-centos7.x86_64.rpm:
	...
	docker exec centos7_build bash -c "cd /opt; git clone -b v${CURVER} https://github.com/ddelnano/proxysql.git proxysql"
	sleep 2
...
binaries/proxysql-${CURVER}-1-fedora24.x86_64.rpm:
	...
	docker exec fedora24_build bash -c "cd /opt; git clone -b v${CURVER} https://github.com/ddelnano/proxysql.git proxysql"
	sleep 2
...
binaries/proxysql_${CURVER}-ubuntu12_amd64.deb:
	...
	docker exec ubuntu12_build bash -c "cd /opt; git clone -b v${CURVER} https://github.com/ddelnano/proxysql.git proxysql"
	sleep 2
	docker exec ubuntu12_build bash -c "cd /opt/proxysql; sed -i -e 's/c++11/c++0x/' lib/Makefile ; sed -i -e 's/c++11/c++0x/' src/Makefile"
	docker exec ubuntu12_build bash -c "cd /opt/proxysql/deps/re2 ; rm re2.tar.gz ; wget -O re2.tar.gz https://github.com/ddelnano/proxysql/raw/v1.3.9/deps/re2/re2-20140304.tgz"
...
binaries/proxysql_${CURVER}-ubuntu14_amd64.deb:
	...
	docker exec ubuntu14_build bash -c "cd /opt; git clone -b v${CURVER} https://github.com/ddelnano/proxysql.git proxysql"
	sleep 2
...
binaries/proxysql_${CURVER}-ubuntu16_amd64.deb:
	...
	docker exec ubuntu16_build bash -c "cd /opt; git clone -b v${CURVER} https://github.com/ddelnano/proxysql.git proxysql"
	sleep 2
...
binaries/proxysql_${CURVER}-debian7_amd64.deb:
	...
	docker exec debian7_build bash -c "cd /opt; git clone -b v${CURVER} https://github.com/ddelnano/proxysql.git proxysql"
	sleep 2
...
binaries/proxysql_${CURVER}-debian8_amd64.deb:
	...
	docker exec debian8_build bash -c "cd /opt; git clone -b v${CURVER} https://github.com/ddelnano/proxysql.git proxysql"
	sleep 2
...
binaries/proxysql_${CURVER}-debian9_amd64.deb:
	...
	docker exec debian9_build bash -c "cd /opt; git clone -b v${CURVER} https://github.com/ddelnano/proxysql.git proxysql"
	sleep 2
